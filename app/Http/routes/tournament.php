...
Route::post('tournament/{tournament}/update', 	['as' => 'tournament.update', 		'uses' =>  'TournamentController@update', 		'middleware' => 'auth']);
Route::get('tournament/{tournament}/delete', 	['as' => 'tournament.delete',		'uses' =>  'TournamentController@delete', 		'middleware' => 'auth']);
