...
{
	// constant responsible for tournament score value.
	// used by the addTournamentScore method.
	const BASE_POW = 0.9;
	
	// tournament_score value for continuous tournament.
	// used by the addTournamentScore method.
	public $ts = 0;
	
	public function tournaments() {
	
		return $this->belongsToMany('Jackmarshall\Tournament', 'players_tournaments', 'player', 'tournament');
	}
		
	public function opponents(Tournament $tournament) {
	...
	public function updateScore(Tournament $tournament) {
	...
	public function updateSos(Tournament $tournament) {
	...
	public function reports(Tournament $tournament)
	{
                return $this->hasMany('Jackmarshall\Report', 'player')
