...
// 	$('#addPlayerText').on('keyup', function() {
// 			var val = $(this).val();
// 			var view = $(this).parents('form').find('#registeredPlayersFieldset');
// 			$.get('tournaments/create', {term: val}, function(response) {
// 					var newView = $(response).find('#registeredPlayersFieldset');
// 					view.empty().append(newView.children());
// 			});
// 	});
